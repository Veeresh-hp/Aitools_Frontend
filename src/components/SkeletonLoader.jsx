...
export const ToolCardSkeleton = () => (
  <div className="relative bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-xl rounded-2xl overflow-hidden border border-gray-700/50">
    ...
    {/* Image Skeleton */}
    <div className="relative h-48 bg-gray-800/70">
    ...
    <div className="px-5 pt-4 pb-16">
      {/* Title Skeleton */}
      <div className="h-6 bg-gray-700/50 rounded-lg mb-3 w-3/4 animate-pulse" />
    ...
    <div className="absolute bottom-3 left-3 flex items-center gap-2">
      <div className="h-6 w-20 bg-gray-700/50 rounded-lg animate-pulse" />
...
export const HeroSkeleton = () => (
  <section className="relative min-h-[60vh] flex items-center justify-center px-4 py-20">
    <div className="max-w-4xl mx-auto text-center space-y-6">
      {/* Title Skeleton */}
      <div className="h-16 bg-gray-700/50 rounded-2xl w-3/4 mx-auto animate-pulse mb-4" />
      <div className="h-16 bg-gray-700/50 rounded-2xl w-2/3 mx-auto animate-pulse mb-8" />
      
      {/* Search Bar Skeleton */}
      <div className="max-w-3xl mx-auto">
        <div className="h-16 bg-gray-700/50 rounded-2xl animate-pulse" />
      </div>
    </div>
  </section>
);
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gray-800 rounded-2xl p-8 mb-8 border border-gray-700">
        <div className="flex flex-col lg:flex-row gap-6">
          {/* Image Skeleton */}
          <div className="w-full lg:w-48 h-48 bg-gray-700/50 rounded-xl animate-pulse flex-shrink-0" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[1, 2, 3].map((i) => (
            <div key={i} className="bg-gray-800 rounded-xl overflow-hidden border border-gray-700">
              <div className="h-40 bg-gray-700/50 animate-pulse" />
